...
set(MP_CC "/opt/homebrew/bin/avr-gcc" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler")
set(MP_CC_DIR "/opt/homebrew/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler base directory")
set(CMAKE_C_COMPILER "/opt/homebrew/bin/avr-gcc" CACHE FILEPATH "Path to the compiler binary")
...
set(MP_CPPC "/opt/homebrew/bin/avr-g++" CACHE PATH "Legacy variable from MPLAB X pointing to the c++ compiler")
set(MP_CPPC_DIR "/opt/homebrew/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the c++ compiler base directory")
set(CMAKE_CXX_COMPILER "/opt/homebrew/bin/avr-g++" CACHE FILEPATH "Path to the compiler binary.")
...
set(MP_AS "/opt/homebrew/bin/avr-gcc" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler")
set(MP_AS_DIR "/opt/homebrew/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler base directory")
set(CMAKE_ASM_COMPILER "/opt/homebrew/bin/avr-gcc" CACHE FILEPATH "Path to the compiler binary.")

# Legacy variable from MPLAB X pointing to the assembler binary.
set(MP_AS ${CMAKE_ASM_COMPILER})

set(MP_LD "/opt/homebrew/bin/avr-ld" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the linker binary.")
set(MP_LD_DIR "/opt/homebrew/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the linker base directory")

set(MP_AR "/opt/homebrew/bin/avr-ar" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the archiver binary.")
set(MP_AR_DIR "/opt/homebrew/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the archiver base directory")

set(CMAKE_AR "/opt/homebrew/bin/avr-ar" CACHE FILEPATH "Path to the archiver binary.")

set(OBJCOPY "/opt/homebrew/bin/avr-objcopy" CACHE FILEPATH "Path to objcopy executable")
set(OBJDUMP "/opt/homebrew/bin/avr-objdump" CACHE FILEPATH "Path to objdump executable")
