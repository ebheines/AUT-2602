...
set(MP_CC "/Applications/microchip/xc8/v3.00/bin/xc8-cc" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler")
set(MP_CC_DIR "/Applications/microchip/xc8/v3.00/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler base directory")
...
set(MP_AS "/Applications/microchip/xc8/v3.00/bin/xc8-cc" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler")
set(MP_AS_DIR "/Applications/microchip/xc8/v3.00/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler base directory")
...
set(MP_LD_DIR "/Applications/microchip/xc8/v3.00/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the linker base directory")
...
set(MP_AR_DIR "/Applications/microchip/xc8/v3.00/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the archiver base directory")

set(CMAKE_AR "/Applications/microchip/xc8/v3.00/bin/xc8-ar" CACHE FILEPATH "Path to the archiver binary.")

set(OBJDUMP "/Applications/microchip/xc8/v3.00/bin/avr-objdump" CACHE FILEPATH "Path to objdump executable")
